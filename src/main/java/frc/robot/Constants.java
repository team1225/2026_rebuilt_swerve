...
public final class Constants {
	...
	public static final class DrivetrainConstants {
		...
		public static final double MAX_SPEED_METERS_PER_SECOND = 16;//8.0; // 4.0; //4.42; //4.8;
	...
	public static final class ShooterConstants {
		public static final double SHOOTER_SPEED_RPM = 4700;//TODO: determine this value experimentally
